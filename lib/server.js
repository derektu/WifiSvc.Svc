...
var WifiCmd_TPLink = require('./wificmd_tplink.js');
...
var Server = function(options, jobSchedule) {
    ...
    var wifiConfig = options.wifi;

    var wificmd = null;
    if (wifiConfig.type == "TP")
        wificmd = new WifiCmd_TPLink(wifiConfig);
    else
        wificmd = new WifiCmd(wifiConfig);
    ...
    function api_macfilter(req, res, mac, add, autorevert) {
        ...
        setTimeout(function() {
            wificmd.enableMac(mac, add, function(err, result) {
